...
class Economy(commands.Cog):
    ...
    @with_db
    async def balance(self, inter: discord.Interaction, db: AsyncSession) -> None:
    ...
    @with_db
    async def daily(self, inter: discord.Interaction, db: AsyncSession) -> None:
    ...
    @with_db
    async def work(self, inter: discord.Interaction, db: AsyncSession) -> None:
    ...
    @with_db
    async def bankrob(self, inter: discord.Interaction, db: AsyncSession) -> None:
    ...
    @with_db
    async def beg(self, inter: discord.Interaction, db: AsyncSession) -> None:
    ...
    @with_db
    async def gamble(self, inter: discord.Interaction, db: AsyncSession, amount: int) -> None:
        user_id = str(inter.user.id)
